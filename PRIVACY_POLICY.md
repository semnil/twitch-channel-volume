...
- **Storage**: GraphQL responses and ad cues are not stored. Only the required values are extracted and used: channel IDs, and the start and end of an ad break. Ad identifiers, advertiser names and tracking URLs carried by a cue are not read.
